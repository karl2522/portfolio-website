...
const projects = [
    ...
    },
    {
        ...
        description:
            "An all-in-one operations platform for a multi-branch beauty and wellness business. Combines a customer-facing booking site with an internal system covering appointments, café POS, inventory, memberships, staff attendance, and a live sales dashboard — all on a shared, branch-scoped database.",
        tech: ["NextJS", "TypeScript", "Supabase", "PostgreSQL", "Vercel"],
        link: "https://www.amarcabeauty.com/",
        github: "#",
        image: "/images/amarca.jpg",
        domain: "www.amarcabeauty.com",
        caseStudy: {
            overview: "A production platform running the day-to-day operations of a multi-branch beauty café — from the public booking flow customers see to the point-of-sale, inventory, and reporting tools staff and admins use behind it.",
            problem: "Branches were running bookings, café sales, stock, and staff hours across disconnected tools and spreadsheets. Nothing reconciled: inventory drifted from what was actually sold, memberships were tracked by hand, and management had no reliable view of performance across locations.",
            goal: "To unify every branch operation behind one system, so bookings, sales, and stock reconcile automatically into reporting management can trust.",
            solution: "I built a Next.js platform on Supabase where all business logic lives in the database as PostgreSQL functions rather than in the API layer. Routes stay thin and every mutation runs server-side inside a transaction, so pricing, stock deduction, and payment recording cannot be manipulated by the client.",
            features: [
                "Online booking with per-branch availability",
                "Café POS with automatic stock deduction",
                "Inventory with approvals and audit history",
                "Memberships and service packages",
                "Staff attendance and roster management",
                "Role-scoped admin and sales dashboards",
            ],
            tech: {
                Frontend: "Next.js / TypeScript",
                Backend: "PostgreSQL Functions / RPC",
                Database: "Supabase / Row-Level Security",
                Hosting: "Vercel",
            },
            challenges: "The hardest problems were correctness ones. Money and stock operations had to stay accurate under real-world conditions — double-clicked payments, concurrent café orders, and partial failures across related writes. I moved price authority and stock deduction into the database layer, added idempotency to payment recording, and enforced branch scoping through row-level security so staff can only ever act within their own branch.",
            outcome: "The platform runs live across multiple branches, handling real bookings, café transactions, and inventory daily, with role-scoped dashboards giving management a consolidated view of every location.",
            demonstrates: ["Database-first architecture", "Multi-tenant branch scoping", "Transactional integrity", "Role-based access control", "Production operations"],
        },
    },
    {
        title: "Aiva",
